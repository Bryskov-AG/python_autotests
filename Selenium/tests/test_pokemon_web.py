...
def test_positive_login():
    ...
    email.click()
    email.send_keys('santei2@rambler.ru') # введи тут email своего тестового аккаунта на stage окружении (user@mail.com)
    ...
    password.click()
    password.send_keys('Password1') # введи тут пароль своего тестового аккаунта на stage окружении
    ...
    assert trainer_id.text.replace('\n', ': ') == 'ID: 1375', 'Unexpected ID trainer' # введи тут ID своего тренера